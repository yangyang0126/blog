...
1. 数据可视化相关库的介绍
2. 用Excel下拉菜单和数据透视构建记账本（这算是Excel内容，不是Python）
3. 读取并处理Excel数据
4. 做一个家庭支出情况统计
5. 将图表汇总到网页上
6. 休息+问答日
...
1. [用aiml构建英语聊天机器人](Python/1.md)
2. [用myqr构建二维码](Python/15.md)
3. 将PDF转换成Excel
4. [用WordCloud制作图云](Python/9.md)
5. [图形界面入门，制作一个日历](Python/28.md)
6. [批量抠图](Python/30.md)
7. 到此结束~~
