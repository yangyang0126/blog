...
- 默认获取前5页数据，可以通过`for page in range(1,5):  `调整获取的页数。

![小组帖子详情](http://cdn.zhaojingyi0126.com/IMG/17569167-59747d0f3d932ee2.png)

- 默认进入“再次出发的30岁”小组，获取小组帖子。可通过调整网址ID，更换小组。

![小组网址](http://cdn.zhaojingyi0126.com/IMG/17569167-20e32236fdac1ef1.png)
