...
![我的目标](12.assets/17569167-c39ba4deed56329d.jpg) 
...
```
![存在web中的网址](12.assets/17569167-5047a521c642f0fe.png)
...
![](12.assets/17569167-f7d20c207482a6ac.png) 
...
![shanbay_data](12.assets/17569167-11251cff7731d443.png)


## 定位数据

网页已经读取成功，接下来我们就需要定位我们需要的数据
![定位数据](12.assets/17569167-2cae166851f17174.png)
...
![find_data中的数据](12.assets/17569167-dd44b6423ecddf74.png)
...
![](12.assets/17569167-e0d46d0a5933a3f0.png)
...
![](12.assets/17569167-d438e0480396088e.png)
...
![](12.assets/17569167-2cb3e184bed6a84d.png)
打开其中一条数据，发现我们要的时间```2019-05-22```和打卡天数```538```在不同的位置
![](12.assets/17569167-d3c62e79859d71a7.png)
...
shanbey_days = checkin.split(",")[3]
```
![](12.assets/17569167-fc1a62d91a81e3ae.png)
...
num_checkin_days.append(str(shanbey_days)[len("\"num_checkin_days\": "):])
```
![checkin_time 打卡日期](12.assets/17569167-87eb564f758fa069.png)
![num_checkin_days 打卡天数](12.assets/17569167-55e1b8bfac6165ba.png)
...
```
![代码运行截图](12.assets/17569167-598df90ac445bec3.png)
...
此时程序运行效果如下：
![](12.assets/17569167-332d6d8555c8c623.png) 
...
```
自动读取ID、查卡、保存到EXCEL
![代码运行截图](12.assets/17569167-2e11112bfda9b2d5.png) 

最后，思考一下，需要导出小组打卡的哪些数据内容，调整代码
小组打卡输出EXCEL情况如下：(昵称和ID做了打码处理)
![](12.assets/17569167-9e1a9bab4b849220.jpg) 
...
![](12.assets/17569167-b0dcf9d3d4f58786.png) 
